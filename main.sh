...
#--------------------------------------------------------------------------------------------------------------------------------
if [ "$BOARD" == "" ]; then
	BOARDS="Cubieboard A10 Cubieboard2 A20 Cubietruck A20 Lime A20 Lime2 A20 Micro A20 Bananapi A20 Orangepi A20 Hummingbird A31 Cubox-i imx6 Udoo imx6 pcDuino3 A20 pcDuino3Nano A20";
